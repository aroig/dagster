...
export interface RunsRootQuery_pipelineRunsOrError_Runs_results_assetNodesToExecute_assetKey {
  __typename: "AssetKey";
  path: string[];
}

export interface RunsRootQuery_pipelineRunsOrError_Runs_results_assetNodesToExecute {
  __typename: "AssetNode";
  assetKey: RunsRootQuery_pipelineRunsOrError_Runs_results_assetNodesToExecute_assetKey;
}
...
export interface RunsRootQuery_pipelineRunsOrError_Runs_results {
  ...
  assetNodesToExecute: RunsRootQuery_pipelineRunsOrError_Runs_results_assetNodesToExecute[] | null;
