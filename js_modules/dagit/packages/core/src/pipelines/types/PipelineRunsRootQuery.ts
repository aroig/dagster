...
export interface PipelineRunsRootQuery_pipelineRunsOrError_Runs_results_assetNodesToExecute_assetKey {
  __typename: "AssetKey";
  path: string[];
}

export interface PipelineRunsRootQuery_pipelineRunsOrError_Runs_results_assetNodesToExecute {
  __typename: "AssetNode";
  assetKey: PipelineRunsRootQuery_pipelineRunsOrError_Runs_results_assetNodesToExecute_assetKey;
}
...
export interface PipelineRunsRootQuery_pipelineRunsOrError_Runs_results {
  ...
  assetNodesToExecute: PipelineRunsRootQuery_pipelineRunsOrError_Runs_results_assetNodesToExecute[] | null;
