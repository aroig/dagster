...
export interface PreviousRunsForScheduleQuery_pipelineRunsOrError_Runs_results_assetNodesToExecute_assetKey {
  __typename: "AssetKey";
  path: string[];
}

export interface PreviousRunsForScheduleQuery_pipelineRunsOrError_Runs_results_assetNodesToExecute {
  __typename: "AssetNode";
  assetKey: PreviousRunsForScheduleQuery_pipelineRunsOrError_Runs_results_assetNodesToExecute_assetKey;
}
...
export interface PreviousRunsForScheduleQuery_pipelineRunsOrError_Runs_results {
  ...
  assetNodesToExecute: PreviousRunsForScheduleQuery_pipelineRunsOrError_Runs_results_assetNodesToExecute[] | null;
